      ...
      <div className="flex items-center space-x-4 w-full md:w-auto">
        <div className="relative flex-grow">
          ...
          <input
            ...
            className="w-full bg-white text-gray-900 rounded-md pl-10 pr-4 py-2 border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
          />
        </div>
        <button 
